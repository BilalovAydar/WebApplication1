...
namespace WebApplication1.Controllers
{
    public class MarksController : Controller
    {
        ...
        public MarksController(MvcWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,MarkOfLesson")] Mark mark)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,MarkOfLesson")] Mark mark)
        {
            if (id != mark.id)
            {
                return NotFound();
